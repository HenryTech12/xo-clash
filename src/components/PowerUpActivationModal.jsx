        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    className="relative max-w-lg w-full bg-surface/95 border border-brand/30 rounded-3xl overflow-hidden shadow-[0_0_80px_rgba(91, 110, 245,0.2)]"
                    style={{ perspective: 1000 }}
                >
                    {/* Header: Identity */}
                    <div className="bg-void p-8 text-center relative border-b border-brand/10">
                        <div className="absolute top-0 left-0 w-full h-1 bg-brand" />
                        <p className="text-[10px] font-black font-orbitron text-brand/60 uppercase tracking-[0.5em] mb-4">
                        ...
                        <div className="relative inline-block mb-6">
                            <motion.div 
                                ...
                                className="absolute -inset-4 border border-dashed border-brand/30 rounded-full"
                            />
                            <div className="p-6 bg-surface-2 rounded-full border border-brand/50 shadow-[0_0_30px_rgba(91, 110, 245,0.3)]">
                        ...
                        <div className="flex justify-center">
                            <span className="px-3 py-1 bg-brand/10 border border-brand/30 rounded-lg text-[10px] font-black font-orbitron text-brand tracking-[0.2em] uppercase">
                    ...
                    <div className="p-10">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-10">
                             <div className="p-4 bg-void/40 border border-white/5 rounded-2xl text-center">
                             ...
                             <div className="p-4 bg-void/40 border border-white/5 rounded-2xl text-center">
                                ...
                                <p className="text-xl font-black font-orbitron text-brand">1 Unit</p>
                             </div>
                        </div>

                        <div className="flex flex-col gap-4 relative z-10">
                            <motion.button
                                whileHover={{ scale: 1.02, boxShadow: "0 0 30px rgba(91, 110, 245,0.4)" }}
                                whileTap={{ scale: 0.98 }}
                                onClick={onConfirm}
                                disabled={isLoading}
                                className="w-full py-5 bg-brand text-void rounded-2xl font-black font-orbitron text-sm tracking-[0.4em] uppercase transition-all flex items-center justify-center gap-3"
                            >
                    ...
                    {/* Decorations */}
                    <div className="absolute bottom-0 left-0 w-full h-0.5 bg-linear-to-r from-transparent via-brand/20 to-transparent" />
                </motion.div>
            </motion.div>
        </AnimatePresence>
    );
