...
public class AppExceptionHandler {
    ...
    public Map<String, Object> handleJwtException(JwtException jwtException, HttpServletRequest request, HttpServletResponse servletResponse) {
        return handleCustomMailException(jwtException, "Invalid JWT TOKEN", request, servletResponse);
    }
